...
\begin{itemize}
	...
	\resitem{Communicate effectively with team regarding scheduling, goals, and distribution of notes.}
		\resitem{Transform the Ethereum Yellowpaper into a more accessible and readable format. \\ (Ongoing.) \url{https://www.github.com/chronaeon/off-whitepaper.git}}
		\resitem{Blog on crypto-economic mechanism design. \\ (Ongoing.) \url{https://medium.com/@micah.dameron/closed-loop-incentive-structures-casper-vs-pow-8e739becab97}}
\end{itemize}
